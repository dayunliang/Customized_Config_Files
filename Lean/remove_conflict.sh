...
disable_config() {
    ...
    # 删除旧的启用行
    sed -i "/^${key}=y$/d" "$CONFIG_FILE"
    sed -i "/^${key}=m$/d" "$CONFIG_FILE"
...
disable_config "CONFIG_PACKAGE_luci-app-ksmbd"
disable_config "CONFIG_PACKAGE_luci-app-samba4"
disable_config "CONFIG_PACKAGE_luci-app-samba"
disable_config "CONFIG_PACKAGE_luci-i18n-ksmbd-zh-cn"
disable_config "CONFIG_PACKAGE_autosamba"
disable_config "CONFIG_PACKAGE_ksmbd"
disable_config "CONFIG_PACKAGE_kmod-fs-ksmbd"
disable_config "CONFIG_PACKAGE_ksmbd-server"
disable_config "CONFIG_PACKAGE_ksmbd-utils"
